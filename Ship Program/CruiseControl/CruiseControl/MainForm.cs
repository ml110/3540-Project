...
//////// End of right-side information update code ///////////////////////////////////////////////////
		...
		{
			ScheduleForm schedFrm = new ScheduleForm(getTripNum(), connection, command);
			schedFrm.Visible = true;
		}

		//start the deck map form
		private void btnMap_Click(object sender, EventArgs e)
		{
			DeckMapForm mapFrm = new DeckMapForm(getTripNum());
			mapFrm.Visible = true;
		}

		//start the dinner form
        private void btnDinner_Click(object sender, EventArgs e)
        {
            DinnerForm dinnerFrm = new DinnerForm(getTripNum());
            dinnerFrm.Visible = true;
        }

		//start the trip plan form
        private void btnTripPlan_Click(object sender, EventArgs e)
        {
            TripManagmentForm planFrm = new TripManagmentForm(getTripNum());
            planFrm.Visible = true;
        }

		//start the billing form
		private void btnBill_Click(object sender, EventArgs e)
		{
			BillingForm billFrm = new BillingForm(connection, command, getTripNum());
			billFrm.Visible = true;
		}

		//start the bar form
		private void btnBar_Click(object sender, EventArgs e)
		{
			DrinkForm barFrm = new DrinkForm(connection, command, getTripNum(), shipNum);
			barFrm.Visible = true;
		}
		...
		{
			GiftForm giftFrm = new GiftForm(connection, command, getTripNum(), shipNum);
			giftFrm.Visible = true;
		}
