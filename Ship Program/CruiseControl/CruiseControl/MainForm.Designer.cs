namespace CruiseControl
{
    partial class MainForm
    {
        ...
        private void InitializeComponent()
        {
			...
			// lblCurrentTrip
			// 
			this.lblCurrentTrip.BackColor = System.Drawing.Color.LightGray;
			...
			// btnTripPlan
			// 
			this.btnTripPlan.BackColor = System.Drawing.Color.LightGray;
			...
			this.btnTripPlan.UseVisualStyleBackColor = false;
			this.btnTripPlan.Click += new System.EventHandler(this.btnTripPlan_Click);
			// 
			// btnMap
			// 
			this.btnMap.BackColor = System.Drawing.Color.LightGray;
			...
			// btnBill
			// 
			this.btnBill.BackColor = System.Drawing.Color.LightGray;
			...
			// btnSchedule
			// 
			this.btnSchedule.BackColor = System.Drawing.Color.LightGray;
			...
			// btnDinner
			// 
			this.btnDinner.BackColor = System.Drawing.Color.LightGray;
			...
			// btnGift
			// 
			this.btnGift.BackColor = System.Drawing.Color.LightGray;
			...
			this.btnGift.UseVisualStyleBackColor = false;
			this.btnGift.Click += new System.EventHandler(this.btnGift_Click);
			// 
			// btnBar
			// 
			this.btnBar.BackColor = System.Drawing.Color.LightGray;
			...
			// lblTripString
			// 
			this.lblTripString.BackColor = System.Drawing.Color.Silver;
			...
			this.Name = "MainForm";
			this.Text = "CRUISE CONTROL: Main Panel";
