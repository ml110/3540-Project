...
namespace customerSignUp
{
    public partial class MapForm : Form
    {
        ...
        passValuesToForm cs = new passValuesToForm();
        ...
        private int tripID, roomTypeId; //////


        public MapForm(string fName, string lName, string phone, string address, string country, string email, string shipName, string numberOfGuest, string city, DateTime dateOfBirthGus0, string departureDate, string departureDateSql,DateTime departureDateForCal, string tripId, string tripDetails)
        {
            InitializeComponent();

            cs.passFnameValue = fName;
            cs.passLnameValue = lName;
            cs.passPhoneValue = phone;
            cs.passAddressValue = address;
            cs.passCountryValue = country;
            cs.passEmailValue = email;
            cs.passShipNameValue = shipName;
            cs.passNumberOfGuestValue = numberOfGuest;
            cs.passCityValue = city;
            cs.passDateOfBirthGus0Value = dateOfBirthGus0;
            cs.passDepartureDateValue = departureDate;
            cs.passDepartureDateSqlValue = departureDateSql;
            cs.passTripIdValue = tripId;
            cs.passTripDetailsValue = tripDetails;
            cs.passDepartureDateForCal = departureDateForCal;
        ...
        {
            tripID = int.Parse(cs.passTripIdValue); //////////// link trip to parent forum
            //tripID = 1;
        ...
        {
            string deckName = cbDeck.Text.Trim();
            string roomNum = ((Button)sender).Text.Trim();

            Billing nextForm = new Billing(cs.passFnameValue, cs.passLnameValue, cs.passPhoneValue, cs.passAddressValue, cs.passNumberOfGuestValue, cs.passShipNameValue, cs.passEmailValue, cs.passCountryValue, cs.passCityValue, cs.passDateOfBirthGus0Value, cs.passDepartureDateValue, cs.passDepartureDateSqlValue, cs.passDepartureDateForCal, cs.passTripIdValue, cs.passTripDetailsValue, deckName, roomNum, roomTypeId);
            this.Hide();
            nextForm.ShowDialog();
            this.Close();
