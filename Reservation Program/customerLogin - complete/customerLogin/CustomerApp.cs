...
namespace customerSignUp
{
    public partial class Form1 : Form
    {
        ...
        private MySqlCommand cmd,comm;
        private MySqlDataReader sqlReader,sqlReadCountries;

        private int tripidSelected = 0;
        private DateTime unselectedDateBirthGus0, departureDateForCal;
        private string departDateToSqlFormat;
        public Form1()
        {
            InitializeComponent();
        }
        ...
        public void comboBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                while (myReader.Read()) // while READING
                {
                    ...
                    departureDateForCal = (DateTime)myReader["DPartDate"];
                    departDateToSqlFormat = departureDateForCal.ToString("yyyy-MM-dd");
                    txtBoxDepartDate.Text = departureDateForCal.ToString("MMMM dd, yyyy"); 
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if(tripDetails.SelectedIndex > -1)
            {
                labelItinerary.ForeColor = Color.Black;
                labelItinerary.Text = string.Empty;
            }
            else
            {
                labelItinerary.ForeColor = Color.Red;
                labelItinerary.Text = "x";
                wrong = true;
            }
